...
app.factory('socket', ['socketFactory',
    function (socketFactory) {
        return socketFactory({
            prefix: '',
            ioSocket: io.connect('http://cafenica.centroclima.org/')
        });
    }
]);
...
app.factory('widget', ['$http', function ($http) {
    ...
    w.getAll = function () {
        ...
        return $http.get('http://cafenica.centroclima.org/getWidgets').success(function (data) {
            return data;
        });
    };
    return w;
...
app.factory('posts', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://cafenica.centroclima.org/posts').success(function (data) {

            angular.copy(data, o.posts);
        });
    };
    o.create = function (post) {
        return $http.post('http://cafenica.centroclima.org/posts', post, {
    ...
    o.upvote = function (post) {
        return $http.put('http://cafenica.centroclima.org/posts/' + post._id + '/upvote', null, {
    ...
    o.get = function (id) {
        return $http.get('http://cafenica.centroclima.org/posts/' + id).then(function (res) {
            return res.data;
        });
    };
    o.addComment = function (id, comment) {
        return $http.post('http://cafenica.centroclima.org/posts/' + id + '/comments', comment, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        });
    };
    o.upvoteComment = function (post, comment) {
        return $http.put('http://cafenica.centroclima.org/posts/' + post._id + '/comments/' + comment._id + '/upvote', null, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        })
          .success(function (data) {
              comment.upvotes += 1;
...
app.factory('user', ['$http', 'auth', function ($http, auth) {
  ...
  headers: {Authorization: 'Bearer '+auth.getToken()}
    ...
    o.getAll = function () {
        return $http.get('http://cafenica.centroclima.org/users', {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).then(function (res) {
            return res.data;
        });
    ...
    o.get = function (id) {
        return $http.get('http://cafenica.centroclima.org/users/' + id).then(function (res) {
            return res.data;
        });
    };
...
app.factory('auth', ['$http', '$state', '$window', function ($http, $state, $window) {
    ...
    auth.logIn = function (user) {
        return $http.post('http://cafenica.centroclima.org/login', user).success(function (data) {
            auth.saveToken(data.token);
        });
    };
    // Tech 12 / 1
    ...
    auth.GenOtp = function (user) {
        /*return $http.post('http://cafenica.centroclima.org/requestpasswordchange', user).success(function(data){
          auth.saveToken(data.token);
        });*/
        //return $http.post('http://cafenica.centroclima.org/requestpasswordchange', user).success(function (data) {
        //    return data;
...
app.factory('unit', ['$http', 'auth', '$window', function ($http, auth, $window) {
    ...
    o.getAll = function (id) {
        return $http.get('http://cafenica.centroclima.org/users/' + id + '/units').success(function (data) {
            return data;
        });
    };
    o.get = function (userId, id) {
        return $http.get('http://cafenica.centroclima.org/users/' + userId + '/units/' + id).then(function (res) {
            return res.data;
        });
    };
    ...
    o.create = function (unit, id) {
        //localhost unit
        return $http.post('http://cafenica.centroclima.org/users/' + id + '/units', unit, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (unit, id, unitData) {
        //localhost unit
        return $http.put('http://cafenica.centroclima.org/users/' + id + '/units/' + unit, unitData, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data
        });
    ...
    o.deleteUnit = function (unitId, userId) {
        return $http.delete('http://cafenica.centroclima.org/users/' + userId + '/units/' + unitId, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return unitId;
        });
    ...
    o.SyncUserServerDataToLocalPouchDb = function (lastSyncDateTime, id) {
        return $http.post('http://cafenica.centroclima.org/SyncUserServerData/' + id + "/"+ lastSyncDateTime, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('varieties', ['$http', 'auth', '$window', function ($http, auth, $window) {
    var o = {};
    o.getAll = function () {
        return $http.get('http://cafenica.centroclima.org/varieties').success(function (data) {
            return data;
        });
    };
    o.create = function (varieties) {
        //localhost unit
        return $http.post('http://cafenica.centroclima.org/varieties', varieties, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.deleteVariety = function (Ided) {
        return $http.delete('http://cafenica.centroclima.org/varieties', {
...
app.factory('methods', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://cafenica.centroclima.org/admin/methods/').success(function (data) {
            return data;
        });
    };
    o.create = function (method) {
        return $http.post('http://cafenica.centroclima.org/admin/methods', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (method) {
        return $http.put('http://cafenica.centroclima.org/admin/methods', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('methodsGallo', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://cafenica.centroclima.org/admin/methodsGallo/').success(function (data) {
            return data;
        });
    };
    o.create = function (methodGallo) {
        return $http.post('http://cafenica.centroclima.org/admin/methodsGallo', methodGallo, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.update = function (methodGallo) {
        return $http.put('http://cafenica.centroclima.org/admin/methodsGallo', methodGallo, {
...
app.factory('campoService', ['$http', 'auth', function ($http, auth) {
    ...
    o.get = function () {
        return $http.get('http://cafenica.centroclima.org/admin/campo/').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://cafenica.centroclima.org/admin/campo/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (method) {
        return $http.post('http://cafenica.centroclima.org/admin/campo', method, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
    ...
    o.SaveCampoUnitTest = function (data) {
        return $http.post('http://cafenica.centroclima.org/admin/campo/addtests', data, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('roya', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://cafenica.centroclima.org/roya').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://cafenica.centroclima.org/roya/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (roya) {
        return $http.post('http://cafenica.centroclima.org/roya', roya, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
...
app.factory('gallo', ['$http', 'auth', function ($http, auth) {
    ...
    o.getAll = function () {
        return $http.get('http://cafenica.centroclima.org/gallo').success(function (data) {
            return data;
        });
    };
    o.getUser = function (userID) {
        return $http.get('http://cafenica.centroclima.org/gallo/' + userID).success(function (data) {
            return data;
        });
    };
    o.create = function (gallo) {
        return $http.post('http://cafenica.centroclima.org/gallo', gallo, {
            headers: { Authorization: 'Bearer ' + auth.getToken() }
        }).success(function (data) {
            return data;
        });
